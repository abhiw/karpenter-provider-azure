...
func (in *AKSNodeClassSpec) DeepCopyInto(out *AKSNodeClassSpec) {
	*out = *in
	...
	if in.InterconnectBlockID != nil {
		in, out := &in.InterconnectBlockID, &out.InterconnectBlockID
		*out = new(string)
		**out = **in
	}
	if in.InterconnectGroupID != nil {
		in, out := &in.InterconnectGroupID, &out.InterconnectGroupID
		*out = new(string)
		**out = **in
	}
	if in.InterconnectSubgroupID != nil {
		in, out := &in.InterconnectSubgroupID, &out.InterconnectSubgroupID
		*out = new(string)
		**out = **in
	}
}
